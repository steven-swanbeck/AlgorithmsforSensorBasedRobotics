function [theta_0] = redundancy_resolution(T_sd, theta_0, M, S_mat, k0, should_plot, M_intermediates, alpha_0, w_tol, v_tol, fading_memory_size, fading_memory_tolerance)
...
%             pause(0.03);
        ...
        if count <= 2
            ...
            previous_thetas(:, 2) = previous_thetas(:, 1); 
