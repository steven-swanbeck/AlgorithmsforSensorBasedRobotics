...
[package1] = read_txt('pa1-debug-f-calbody.txt'); % works (contains di, ai, ci)
[package2] = read_txt('pa1-debug-f-calreadings.txt'); % works (contains n_frames, each of di, ai, ci)
[package3] = read_txt('pa1-debug-f-empivot.txt'); % works (contains n_frames, each of gi)
[package4] = read_txt('pa1-debug-f-optpivot.txt'); % works (contains n_frames, each of di, hi)
[package5] = read_txt('pa1-debug-f-output1.txt');  % works (contains n_frames, each of ci)
