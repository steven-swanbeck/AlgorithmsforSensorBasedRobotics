function [b_tip, b_post, T_bank, A, b] = pivot_calibration2(raw)
...
%     our defined transformation between first frame and sensor
    R0 = eye(3);
    a_sum = [0, 0, 0];
...
%     b(1:3) = -T_bank{1}(1:3, 4);
    ...
    for i = 1:size(raw, 2) - 1
        T_bank{i + 1} = correspondence_registration(raw{i}, raw{i + 1});
