function [theta_0, x, y, z] = DLS_inverse_kinematics(T_sd, theta_0, M, S_mat, k, should_plot, M_intermediates, produce_gif, gif_name, alpha_0, w_tol, v_tol, fading_memory_size, fading_memory_tolerance)
