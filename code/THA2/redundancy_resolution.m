function [theta_0, x, y, z] = redundancy_resolution(T_sd, theta_0, M, S_mat, k0, should_plot, M_intermediates, produce_gif, gif_name, alpha_0, w_tol, v_tol, fading_memory_size, fading_memory_tolerance)
...
%         end
        ...
        additional_update = k0 * (eye(size(J_b' * J_b, 2)) - J_dagger(J_b) * J_b) * q0_dot;
