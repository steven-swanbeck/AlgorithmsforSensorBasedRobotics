function plotFrame_T(T, label, delta, alpha)
...
%   distance unit.
    ...
    line('XData', [origin(1) origin(1) + delta * T(1,1)], 'YData', [origin(2) origin(2) + delta * T(2,1)],...
        'ZData', [origin(3) origin(3) + delta * T(3,1)], 'Color',[1, 0, 0, alpha],'LineWidth',3);
    
    % y-axis
    line('XData', [origin(1) origin(1) + delta * T(1,2)], 'YData', [origin(2) origin(2) + delta * T(2,2)],...
        'ZData', [origin(3) origin(3) + delta * T(3,2)], 'Color',[0, 1, 0, alpha],'LineWidth',3);
   
    % z-axis
    line('XData', [origin(1) origin(1) + delta * T(1,3)], 'YData', [origin(2) origin(2) + delta * T(2,3)],...
        'ZData', [origin(3) origin(3) + delta * T(3,3)], 'Color',[0, 0, 1, alpha], 'LineWidth',3);
