...
% IK using DLS
k = 0.3;
[theta_f, x, y, z] = DLS_inverse_kinematics(T_sd, theta_0, M, S_mat, k, true, M_intermediates, true, gif_name);
...
cla;
plot3(x, y, z, '-', 'Color', '#FF00FF', 'LineWidth', 3)
...
title(strcat('Damped Least-Squares IK', {' '}, test_name))
