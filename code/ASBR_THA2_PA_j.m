...
% IK using RR 
k0 = 0.1;
[theta_f, x, y, z] = redundancy_resolution(T_sd, theta_0, M, S_mat, k0, true, M_intermediates, true, gif_name);
...
cla;
plot3(x, y, z, '-', 'Color', '#FFFF00', 'LineWidth', 3)
...
title(strcat('Redundancy Resolution IK', {' '}, test_name))
