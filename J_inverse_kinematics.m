function [theta_0, x, y, z] = J_inverse_kinematics(T_sd, theta_0, M, S_mat, should_plot, M_intermediates, alpha_0, w_tol, v_tol, fading_memory_size, fading_memory_tolerance)
